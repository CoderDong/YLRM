...
//        // 版本号一样，不显示新特性
//        HomeTabbarController *homeTabbar = [[HomeTabbarController alloc]init];
//        self.window.rootViewController = homeTabbar;
//        [self.window makeKeyAndVisible];
//    }else{
        // 版本号bu一样，显示新特性
        NewFetherViewController *newFether = [[NewFetherViewController alloc]init];
        self.window.rootViewController = newFether;
//    }
    [self.window makeKeyAndVisible];
    return YES;
}
